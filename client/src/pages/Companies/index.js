				...
				<div className="companies_container">
			    	...
			    	<Loader  loading={loading}/>

				    	{
					    	...
					    	: !loading && !filter_by?
					    	(	
					    		<p className="companies_info"> No companies found</p>
					    	):null
				    }
				    {
				    	 company_lists.length==0 && !loading && filter_by?
					    	<p className="companies_info"> No companies found for this college try other college</p>:null
